...
const contrainerClasses =
  'inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium tracking-normal'
const dotClasses = 'w-2 h-2 mr-1 rounded-full'

const StatusPill = ({ margin = 'top', status = 'success', label = '' }) => {
